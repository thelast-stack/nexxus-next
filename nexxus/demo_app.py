...
class DemoState:
    ...
    def activate_breakdown(self) -> None:
        ...
        self.messages = [
            ...
            {"from": "Manutenção", "to": "IA Mestre", "text": "Falha do motor; estimativa de reparação: 6h."},
            {"from": "IA Mestre", "to": "Financeiro", "text": "Qual o impacto estimado da alternativa?"},
            {"from": "Financeiro", "to": "IA Mestre", "text": "Alternativa estimada em 1.800 EUR."},
        ]
    ...
    def decide(self, status: str) -> None:
        if not self.proposal:
            raise ValueError("activate the breakdown first")
